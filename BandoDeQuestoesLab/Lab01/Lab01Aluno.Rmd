...
Vocês irão verificar que a variância amostral teórica é igual $\sigma^2/n$ quando usamos $AAS_c$. No caso $AAS_s$, a variância amostral teórica é $\frac{1}{n}S^2(1-n/N)$.
